import pandas as pd
import urllib
from sklearn import preprocessing, feature_extraction, svm, metrics, tree
...
train_data = open('kddcup.data_10_percent_corrected')
test_data = open('corrected')
...
for cri in criterion:
    for leaf in min_samples_leaf:
        for depth in max_depth:
            ...
            n_splits = 5
            for train, test in model_selection.KFold(n_splits=n_splits, shuffle=True, random_state=20160202).split(train_data_scaled2):
...
train_data_1 =open('kddcup.data_10_percent_corrected')
test_data_1 =open('corrected')
...
for cri in criterion:
    for leaf in min_samples_leaf:
        for depth in max_depth:
            ...
            for train, test in model_selection.KFold(n_splits=5, shuffle=True, random_state=20160202).split(train_data_scaled_1):
